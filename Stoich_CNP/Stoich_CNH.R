...
CN_Hyphae_ID <- read_excel("Raw_data/Stoich/CN_Hyphae_ID.xlsx")
...
CNH<-Hyphae_CN%>%
  ...
  mutate(Site = if_else(is.na(Site), "leaf_std", as.character(Site)),
...
write.csv(CNH, "Processed_data/C_N_Stoich.csv", row.names = FALSE)
